"""
tabs/tab_amortization.py — Full Amortization Schedule tab
"""
import streamlit as st
from datetime import date

from mortgage_math import build_amortization, _year_of
